...
BlockController.prototype.getBlockByHash = function(hash, next) {
    ...
    if (blockCached) {
        ...
        return async.waterfall([function (callback) {
            ...
            return self.node.services.dashd.getBlockHeader(hash, function (err, info) {
...
BlockController.prototype._getBlockSummary = function(hash, moreTimestamp, next) {
  ...
  if (summaryCache) {
      ...
      return async.setImmediate(function() {
        ...
        return async.waterfall([function (callback) {
            return self.node.services.dashd.client.getBlock(hash, function (err, response) {
      ...
      if (err) {
        ...
        var confirmations = self.node.services.dashd.height - block.height + 1;
...
BlockController.prototype.list = function(req, res) {
  ...
  var moreTimestamp = lte;
    ...
    return self.node.services.dashd.getBlockHashesByTimestamp(lte, gte, function (err, hashes) {
